...
# Ага, Якобиан - это штука, которая в каждой точке показывает, куда примерно (приближаем линейной функцией) 
# будет двигаться точка при применении преобразования.

# Элементы матрицы Якоби показывает, куда будет двигаться точка вдоль каждого из направлений 
# при изменении по направления в не преобразованном пространстве

# dyj/dxi -- линейное приближение того, как маленькое изменение координаты xi в непробразованном пространстве 
# повлияет на изменение координаты yj в преобразованном пространстве
